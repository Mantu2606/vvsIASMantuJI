...
namespace FossTech.Areas.FossTech.Controllers
{
    ...
    public class UpdatesController : Controller
    {
        ...
        {
            return View(await _context.Updates
                .Include(b => b.Section)
                .ToListAsync());
        }
        ...
        {
            var results = await _context.Updates.ToListAsync();
            return new ExcelResult<Update>(results, "Demo Sheet Name", "Fingers10");
        }
        ...
        public async Task<IActionResult> Edit(int id,  IFormFile image, Update post)
        {
            ...
            return RedirectToAction(nameof(Index), new {area = "Fosstech"});
        }
        ...
        public async Task<IActionResult> DeleteSelected(List<int> leadIds)
        {
            ...
            var leadsToDelete = await _context.Updates
            .Where(lead => leadIds.Contains(lead.Id))
            .ToListAsync();

            _context.Updates.RemoveRange(leadsToDelete);
            await _context.SaveChangesAsync();
